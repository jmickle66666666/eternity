...
static menuitem_t mn_options_items[] =
{
   ...
   {it_gap},
   {it_info,   "Controls"},
   {it_runcmd, "Customize Controls",    "mn_movekeys" },
   {it_runcmd, "Mouse and Gamepad",         "mn_mouse"    },
   {it_gap},
   { it_info, "Display Settings" },
   ...
   {it_gap},
   {it_info,   "Gameplay Settings"},
   {it_runcmd, "Compatibility",         "mn_compat"   },
   {it_runcmd, "Monster Behaviour",     "mn_enemies"  },
   {it_runcmd, "Weapon Settings",       "mn_weapons"  },
   {it_end}
};
